...
router.get(     '/index.js'       , (req, res, next)=>{ next()},babelify('views/main.js',{minify: true, transform:[cssify]}))
router.get(     '/eLab'           , (req, res, next)=>{ res.render('Layout.js',{title: 'eLab', page:'eLab home page', script: '/eLab.js'}) });
router.get(     '/eLab.js'        , (req, res, next)=>{ next() },babelify('views/frontApi/eLab/eLab.js',{minify: true, transform:[cssify]}));
...
router.get(     '/Login.js'       , babelify('views/Login.js',{minify: true, transform:[cssify]}),(req, res)=>{console.log('work')});
...
//Admin Area
router.get(     '/admlab.js'     ,  babelify('views/adminApi/AdmLab.js',{minify: true, transform:[cssify]}));
